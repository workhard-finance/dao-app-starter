...
const RPC_URL = 'https://eth-mainnet.alchemyapi.io/v2/bivBn3T5USHWOXkTyBCXTp0R9ogelinE'
...
export const ledger = new LedgerConnector({ chainId: 1, url: RPC_URL, pollingInterval: POLLING_INTERVAL })
