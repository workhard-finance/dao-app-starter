...
export const ProposeBatchTx: React.FC = ({}) => {
    ...
    const [minimumVotingPeriod, setMinimumVotingPeriod] = useState<BigNumberish>();
    const [maximumVotingPeriod, setMaximumVotingPeriod] = useState<BigNumberish>();
    const [minimumVotesForProposal, setMinimumVotesForProposal] = useState<BigNumberish>();

    /** array of proposals **/
    const [indexes, setIndexes] = React.useState<number[]>([]);
    const [counter, setCounter] = React.useState(0);
    const [proposalProperties, setProposalProperties] = React.useState<{ [key: number]: ProposeTx }>({});
    ...
    const handleSubmit: FormEventHandler = (event) => {
        ...
        if (Object.values(proposalProperties).length == 0) return alert("properties are not set");
    ...
    return (
        <Card>
            <Card.Header as="h5">Submit a new proposal Batch manner (manual)</Card.Header>
            <Card.Body>
                            ...
                            <Card>
                                ...
                                <Form.Group>
                                    ...
                                    <Form.Control
                                        ...
                                        onChange={({target: {value}}) => setProposalProperties(prevState => {
                                            return {
                                                ...prevState,
                                                [index]: {
                                                    ...prevState[index],
